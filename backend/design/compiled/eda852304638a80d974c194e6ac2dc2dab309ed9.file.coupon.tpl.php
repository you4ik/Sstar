<?php /* Smarty version Smarty-3.1.18, created on 2016-11-19 00:21:45
         compiled from "backend\design\html\coupon.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31360582f70e9ed9086-09473314%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eda852304638a80d974c194e6ac2dc2dab309ed9' => 
    array (
      0 => 'backend\\design\\html\\coupon.tpl',
      1 => 1476800152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31360582f70e9ed9086-09473314',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_582f70ea0656f3_44403322',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_582f70ea0656f3_44403322')) {function content_582f70ea0656f3_44403322($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['message_error']->value) {?>
    ...
    <div class="message message_error">
        <span class="text"><?php if ($_smarty_tpl->tpl_vars['message_error']->value=='code_exists') {?>Купон с таким кодом уже существует<?php } elseif ($_smarty_tpl->tpl_vars['message_error']->value=='empty_code') {?>Введите код купона<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_error']->value;?>
<?php }?></span>
		...
		<div class="block layer">
			<ul>
				<li>
                    ...
                    <input name="value" class="coupon_value" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['coupon']->value->value, ENT_QUOTES, 'UTF-8', true);?>
" />
			...
			<ul>
				<li>
                    <label class=property>
                        <input type=checkbox name="expires" value="1" <?php if ($_smarty_tpl->tpl_vars['coupon']->value->expire) {?>checked<?php }?>>Истекает
                    </label>
