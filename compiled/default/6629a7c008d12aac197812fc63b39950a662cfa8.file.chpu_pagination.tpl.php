<?php /* Smarty version Smarty-3.1.18, created on 2016-11-19 00:14:44
         compiled from "C:\OpenServer\domains\localhost\design\default\html\chpu_pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3416582f6f44a89541-80448266%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6629a7c008d12aac197812fc63b39950a662cfa8' => 
    array (
      0 => 'C:\\OpenServer\\domains\\localhost\\design\\default\\html\\chpu_pagination.tpl',
      1 => 1470915078,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3416582f6f44a89541-80448266',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_582f6f44b46eb2_62424768',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_582f6f44b46eb2_62424768')) {function content_582f6f44b46eb2_62424768($_smarty_tpl) {?>
<?php if ($_smarty_tpl->tpl_vars['total_pages_num']->value>1) {?>
	<ul class="pagination<?php if ($_smarty_tpl->tpl_vars['ajax']->value) {?> is_ajax<?php }?>">
		...
		<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value>1) {?>
			<li class="page-item">
				<a class="page-link" href="<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value==2) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>null),$_smarty_tpl);?>
...
">
		...
		<?php } else { ?>
			<li class="page-item">
				<a class="page-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>null),$_smarty_tpl);?>
">1</a>
			</li>
		<?php }?>
...
?>
			...
			<?php if (($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->tpl_vars['page_from']->value+1&&$_smarty_tpl->tpl_vars['p']->value!=2)||($_smarty_tpl->tpl_vars['p']->value==$_smarty_tpl->tpl_vars['page_to']->value&&$_smarty_tpl->tpl_vars['p']->value!=$_smarty_tpl->tpl_vars['total_pages_num']->value-1)) {?>
				<li class="page-item">
					<a class="page-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>$_smarty_tpl->tpl_vars['p']->value),$_smarty_tpl);?>
">...</a>
				</li>
...
"><?php echo $_smarty_tpl->tpl_vars['p']->value;?>
		...
		<?php } else { ?>
			<li class="page-item">
				<a class="page-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>$_smarty_tpl->tpl_vars['total_pages_num']->value),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['total_pages_num']->value;?>
		...
		<li class="page-item">
			<a class="page-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>'all'),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['lang']->value->pagination_all;?>
		...
		<?php if ($_smarty_tpl->tpl_vars['current_page_num']->value<$_smarty_tpl->tpl_vars['total_pages_num']->value) {?>
			<li class="page-item">
				<a class="page-link" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['furl'][0][0]->filter_chpu_url(array('page'=>$_smarty_tpl->tpl_vars['current_page_num']->value+1),$_smarty_tpl);?>
